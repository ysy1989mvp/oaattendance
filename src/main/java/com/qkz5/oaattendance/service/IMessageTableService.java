...
public interface IMessageTableService {
	/**
	 * 
	 * @param id
	 * @return 通过id查询实体对象
	 ...
	 * @return
	 */
	public ServiceResult<Integer> addMessageTable(MessageTable merchantUser);
	/**
	 * 通过实体id修改实体对象
	 * @param merchantUser
	 * @return
	 */
	public ServiceResult<Integer> updateById(MessageTable merchantUser);
