...
public interface IAttendanceDateTableService {
	/**
	 * 
	 * @param id
	 * @return 通过id查询实体对象
	 ...
	 * @return
	 */
	public ServiceResult<Integer> addAttendanceDateTable(AttendanceDateTable merchantUser);
	/**
	 * 通过实体id修改实体对象
	 * @param merchantUser
	 * @return
	 */
	public ServiceResult<Integer> updateById(AttendanceDateTable merchantUser);
