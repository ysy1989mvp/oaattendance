...
public interface IEmployeeBasicInformationService {
	 ...
	 * @return
	 */
	public ServiceResult<Integer> addEmployeeBasicInformation(EmployeeBasicInformation merchantUser);
	/**
	 * 通过实体id修改实体对象
	 * @param merchantUser
	 * @return
	 */
	public ServiceResult<Integer> updateById(EmployeeBasicInformation merchantUser);
