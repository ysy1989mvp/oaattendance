...
import com.qkz5.oaattendance.dao.IAttendanceSetDAO;
import com.qkz5.oaattendance.entity.mojo.AttendanceSetAO;
import com.qkz5.oaattendance.entity.pojo.AttendanceSet;
import com.qkz5.oaattendance.service.IAttendanceSetService;

@Service
public class AttendanceSetService implements IAttendanceSetService{
	@Autowired
	IAttendanceSetDAO attendanceSetDAO;
	
	@Override
	public ServiceResult<AttendanceSetAO> selectById(Integer id) {
		AttendanceSetAO attendanceSetAO = attendanceSetDAO.selectById(id);
		ServiceResult<AttendanceSetAO> serviceResult = new ServiceResult<AttendanceSetAO>();
		if(attendanceSetAO!=null){
			serviceResult.setCode(200);
			serviceResult.setMsg("通过id查询对象正常");
			serviceResult.setSucceed(true);
			serviceResult.setData(attendanceSetAO);
		}else{
	...
	public ServiceResult<Integer> deleteById(Integer id) {
		...
		Integer result = attendanceSetDAO.deleteById(id);
		if(result!=null){
			serviceResult.setCode(200);
	...
	public ServiceResult<List<AttendanceSetAO>> selectByCriteria(AttendanceSetCriteria criteria) {
		ServiceResult<List<AttendanceSetAO>> serviceResult = new ServiceResult<List<AttendanceSetAO>>();
		List<AttendanceSetAO> resultList = attendanceSetDAO.selectByCriteria(criteria);
		if(resultList!=null){
			serviceResult.setCode(200);
	...
	@Override
	public ServiceResult<Integer> addAttendanceSet(AttendanceSet attendanceSet) {
		ServiceResult<Integer> serviceResult = new ServiceResult<Integer>();
		Integer result = attendanceSetDAO.addAttendanceSet(attendanceSet);
		if(result!=null){
			serviceResult.setCode(200);
	...
	@Override
	public ServiceResult<Integer> updateById(AttendanceSet attendanceSet) {
		ServiceResult<Integer> serviceResult = new ServiceResult<Integer>();
		Integer result = attendanceSetDAO.updateById(attendanceSet);
		if(result!=null){
			serviceResult.setCode(200);
	...
	public ServiceResult<Integer> updateByCriteria(AttendanceSetCriteria criteria) {
		ServiceResult<Integer> serviceResult = new ServiceResult<Integer>();
		if(criteria.getAttendanceSet()==null){
		...
		Integer result = attendanceSetDAO.updateByCriteria(criteria);
		if(result!=null){
			serviceResult.setCode(200);
	...
	public ServiceResult<Integer> deleteByCriteria(AttendanceSetCriteria criteria) {
		ServiceResult<Integer> serviceResult = new ServiceResult<Integer>();
		Integer result = attendanceSetDAO.deleteByCriteria(criteria);
		if(result!=null){
			serviceResult.setCode(200);
	...
	public ServiceResult<Integer> getFeidMaxByCriteria(AttendanceSetCriteria criteria) {
		ServiceResult<Integer> serviceResult = new ServiceResult<Integer>();
		Integer result = attendanceSetDAO.getFeidMaxByCriteria(criteria);
		if(result!=null){
			serviceResult.setCode(200);
	...
	public ServiceResult<Integer> getFeidMinByCriteria(AttendanceSetCriteria criteria) {
		ServiceResult<Integer> serviceResult = new ServiceResult<Integer>();
		Integer result = attendanceSetDAO.getFeidMinByCriteria(criteria);
		if(result!=null){
			serviceResult.setCode(200);
	...
	public ServiceResult<Integer> getFeidAvgByCriteria(AttendanceSetCriteria criteria) {
		ServiceResult<Integer> serviceResult = new ServiceResult<Integer>();
		Integer result = attendanceSetDAO.getFeidAvgByCriteria(criteria);
		if(result!=null){
			serviceResult.setCode(200);
	...
	public ServiceResult<Integer> getFeidSumByCriteria(AttendanceSetCriteria criteria) {
		ServiceResult<Integer> serviceResult = new ServiceResult<Integer>();
		Integer result = attendanceSetDAO.getFeidSumByCriteria(criteria);
		if(result!=null){
			serviceResult.setCode(200);
	...
	public ServiceResult<Integer> getFeidCountByCriteria(AttendanceSetCriteria criteria) {
		ServiceResult<Integer> serviceResult = new ServiceResult<Integer>();
		Integer result = attendanceSetDAO.getFeidCountByCriteria(criteria);
		if(result!=null){
			serviceResult.setCode(200);
