...
public class ApplicationFormService implements IApplicationFormService{
	...
	public ServiceResult<ApplicationFormAO> selectById(Integer id) {
		ApplicationFormAO applicationFormAO = applicationFormDAO.selectById(id);
		ServiceResult<ApplicationFormAO> serviceResult = new ServiceResult<ApplicationFormAO>();
		if(applicationFormAO!=null){
			serviceResult.setCode(200);
			serviceResult.setMsg("通过id查询对象正常");
			serviceResult.setSucceed(true);
			serviceResult.setData(applicationFormAO);
		}else{
	...
	public ServiceResult<Integer> deleteById(Integer id) {
		...
		Integer result = applicationFormDAO.deleteById(id);
		if(result!=null){
			serviceResult.setCode(200);
	...
	public ServiceResult<List<ApplicationFormAO>> selectByCriteria(ApplicationFormCriteria criteria) {
		ServiceResult<List<ApplicationFormAO>> serviceResult = new ServiceResult<List<ApplicationFormAO>>();
		List<ApplicationFormAO> resultList = applicationFormDAO.selectByCriteria(criteria);
		if(resultList!=null){
			serviceResult.setCode(200);
	...
	@Override
	public ServiceResult<Integer> addApplicationForm(ApplicationForm applicationForm) {
		ServiceResult<Integer> serviceResult = new ServiceResult<Integer>();
		Integer result = applicationFormDAO.addApplicationForm(applicationForm);
		if(result!=null){
			serviceResult.setCode(200);
	...
	@Override
	public ServiceResult<Integer> updateById(ApplicationForm applicationForm) {
		ServiceResult<Integer> serviceResult = new ServiceResult<Integer>();
		Integer result = applicationFormDAO.updateById(applicationForm);
		if(result!=null){
			serviceResult.setCode(200);
	...
	public ServiceResult<Integer> updateByCriteria(ApplicationFormCriteria criteria) {
		ServiceResult<Integer> serviceResult = new ServiceResult<Integer>();
		if(criteria.getApplicationForm()==null){
		...
		Integer result = applicationFormDAO.updateByCriteria(criteria);
		if(result!=null){
			serviceResult.setCode(200);
	...
	public ServiceResult<Integer> deleteByCriteria(ApplicationFormCriteria criteria) {
		ServiceResult<Integer> serviceResult = new ServiceResult<Integer>();
		Integer result = applicationFormDAO.deleteByCriteria(criteria);
		if(result!=null){
			serviceResult.setCode(200);
	...
	public ServiceResult<Integer> getFeidMaxByCriteria(ApplicationFormCriteria criteria) {
		ServiceResult<Integer> serviceResult = new ServiceResult<Integer>();
		Integer result = applicationFormDAO.getFeidMaxByCriteria(criteria);
		if(result!=null){
			serviceResult.setCode(200);
	...
	public ServiceResult<Integer> getFeidMinByCriteria(ApplicationFormCriteria criteria) {
		ServiceResult<Integer> serviceResult = new ServiceResult<Integer>();
		Integer result = applicationFormDAO.getFeidMinByCriteria(criteria);
		if(result!=null){
			serviceResult.setCode(200);
	...
	public ServiceResult<Integer> getFeidAvgByCriteria(ApplicationFormCriteria criteria) {
		ServiceResult<Integer> serviceResult = new ServiceResult<Integer>();
		Integer result = applicationFormDAO.getFeidAvgByCriteria(criteria);
		if(result!=null){
			serviceResult.setCode(200);
	...
	public ServiceResult<Integer> getFeidSumByCriteria(ApplicationFormCriteria criteria) {
		ServiceResult<Integer> serviceResult = new ServiceResult<Integer>();
		Integer result = applicationFormDAO.getFeidSumByCriteria(criteria);
		if(result!=null){
			serviceResult.setCode(200);
	...
	public ServiceResult<Integer> getFeidCountByCriteria(ApplicationFormCriteria criteria) {
		ServiceResult<Integer> serviceResult = new ServiceResult<Integer>();
		Integer result = applicationFormDAO.getFeidCountByCriteria(criteria);
		if(result!=null){
			serviceResult.setCode(200);
